 ...
 */
export declare function toBeTrue(condition: boolean, errorMessage?: string): void;
/**
 ...
 * @throws {ExpectationError}
 */
export declare function toBeFalse(condition: boolean, errorMessage?: string): void;
/**
 ...
 * @throws {ExpectationError}
 */
export declare function toExist<T>(value: T, errorMessage?: string): void;
/**
 ...
 * @throws {ExpectationError}
 */
export declare function toNotExist<T>(value: T, errorMessage?: string): void;
/**
 ...
 * @throws {ExpectationError}
 */
export declare function toBeAlphanumeric(value: string, errorMessage?: string): void;
/**
 ...
 * @throws {ExpectationError}
 */
export declare function toBeCharCodes(value: string, minCharCode: number, maxCharCode: number, errorMessage?: string): void;
